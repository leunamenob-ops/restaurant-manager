...
export default function InventariosPage() {
  ...
  async function cargarStock() {
    // MODIFICADO: Hacer JOIN con ubicaciones
  ...
  const sinUbicacion = todosProductos.filter((s) => !s.ubicacion_id);
