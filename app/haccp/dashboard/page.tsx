...
export default function HACCPDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 font-sans text-slate-900 selection:bg-cyan-100 selection:text-cyan-900">
      {/* HEADER CON BOTONES DE NAVEGACIÓN ACTUALIZADOS */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row justify-between items-center py-4 gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 justify-center sm:justify-end">
              <button
                onClick={() => router.push('/haccp/admin')}
                className="px-4 py-2 text-sm font-medium text-cyan-600 bg-cyan-50 rounded-lg hover:bg-cyan-100 transition-all flex items-center gap-2 border border-cyan-200"
              >
