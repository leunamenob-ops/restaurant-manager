...
const CATEGORIAS_FIJAS = [
  ...
  { id: 'CAT_04', nombre: 'Recepción' },
  { id: 'CAT_05', nombre: 'Almacenamiento' },
];
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <select value={pccFiltro} onChange={(e) => setPccFiltro(e.target.value)} className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-2 focus:ring-cyan-500 text-sm disabled:opacity-50" disabled={categoriaFiltro === 'todas'}>
